...
static inline folly::dynamic toDynamic(const RNDatePickerMode &value) {
...
#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const RNDatePickerIs24hourSource &value) {
  return toString(value);
}
#endif
...
#ifdef RN_SERIALIZABLE_STATE
static inline folly::dynamic toDynamic(const RNDatePickerTheme &value) {
  return toString(value);
}
#endif
