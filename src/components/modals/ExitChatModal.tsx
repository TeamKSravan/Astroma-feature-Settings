    ...
    >
      <View style={styles.modalView}>
        <View style={styles.ceneteredView}>
          ...
          <Text style={styles.deleteTitle}>{i18n.t('exitChat.title')}</Text>
          <Text style={styles.deleteText}>{i18n.t('exitChat.arelog')}</Text>
        </View>
        <View style={styles.buttonView}>
          <TouchableOpacity style={styles.noView} onPress={closeModal}>
            <Text style={styles.noText}>{i18n.t('exitChat.cancel')}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.yesView} onPress={handleYes}>
            <Text style={styles.yesText}>{i18n.t('exitChat.exit')}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
